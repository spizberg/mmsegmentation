...
class TraceDataset(CustomDataset):
    """Trace dataset.
    ...
    CLASSES = (
        ...
        'cape', 'bag, wallet', 'hood', 'collar', 'lapel', 'epaulette', 'sleeve', 'pocket',
        'neckline', 'buckle', 'zipper', 'applique', 'bead', 'bow', 'flower', 'fringe', 'ribbon',
